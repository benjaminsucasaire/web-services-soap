...
#creamos funcion para que ejecute el metodo insert del modelo, la cual tendra 3 parametros de entradas
function InsertCategoriaService($request){
    #ingresamos los recursos a utilizar
    require_once "config/conexion.php";
    require_once "models/Usuario.php";
    #creamos un objeto en base a la clase Usuario
    $usuario = new Usuario();
